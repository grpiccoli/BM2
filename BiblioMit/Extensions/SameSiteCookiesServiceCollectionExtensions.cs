...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class SameSiteCookiesServiceCollectionExtensions
    {
        ...
        private static bool DisallowsSameSiteNone(string userAgent)
        {
            ...
            if (userAgent.Contains("CPU iPhone OS 12", StringComparison.InvariantCultureIgnoreCase)
            ...
            if (userAgent.Contains("Safari", StringComparison.InvariantCultureIgnoreCase)
               ...
               && userAgent.Contains("Version/", StringComparison.InvariantCultureIgnoreCase))
            {
                return true;
            }
